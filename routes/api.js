...
today = yyyy + '-' + mm + '-' + dd;
  ...
  var query = `select v.business_name , v.image , v.number , v.address , v.shop_online , v.owner_name_hide , v.owner_name , v.id , (select c.name from category c where c.id = v.categoryid) as categoryname from vendor v where v.id = '${req.query.vendorid}';`
