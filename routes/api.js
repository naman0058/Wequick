  ...
  pool.query(query,(err,result)=>{
      if(err) throw err;
        ...
        //     else {
              ...
              request.get({url:`https://pgapi.vispl.in/fe/api/v1/send?username=aformotpg.trans&password=z3xZ7&unicode=false&from=DLSAAJ&to=8319339945&dltContentId=1307165010197480063&text=${message}`} , function(err,data){
                if(err) throw err;
                else {
