...
router.get('/all',(req,res)=>{
	pool.query(`select b.* , (select v.name from vendor v where v.id = b.vendorid) as vendorname from ${table} b `,(err,result)=>{
		if(err) throw err;
        else res.json(result)
	})
})
